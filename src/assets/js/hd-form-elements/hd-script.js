...
function hdInit(){
    ...
    /*text*/
    var inputTextDivList = document.querySelectorAll(".hd-input-text-container");
    ...
    /*TextArea*/
    var inputTextAreaDivList = document.querySelectorAll(".hd-input-textarea-container");
...
function hdSelectInit(){
    ...
    x = document.getElementsByClassName("hd-select-container");
